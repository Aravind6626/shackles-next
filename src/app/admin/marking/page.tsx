    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 md:mb-10">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Marking & Scoring</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-violet-500">
            <p className="text-gray-600 text-sm uppercase tracking-wide font-semibold">Active Events</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-lime-500">
            <p className="text-gray-600 text-sm uppercase tracking-wide font-semibold">Live Dashboard</p>
            <Link
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
            <p className="text-gray-600 text-sm uppercase tracking-wide font-semibold">Event Manager</p>
            <Link
              href="/admin/events"
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/events" className="text-sm font-semibold text-blue-700 hover:text-blue-800">
              Manage All Events
            </Link>
          </div>

          {events.length === 0 ? (
            <p className="text-sm text-gray-600">No active events found for the current year.</p>
          ) : (
